...
app.get("/", async (req, res) => {
  try {
    ...
    res.send(
      `Conexão com o banco de dados bem-sucedida! Tempo do servidor: ${result.rows[0].now}`
    );
  } catch (err) {
    console.error(err);
...
app.post("/doadores", async (req, res) => {
  try {
    ...
    const newDoador = await client.query(query, values);
...
app.get("/doadores", async (req, res) => {
  try {
    ...
    const allDoadores = await client.query(query);
...
app.put("/doadores/:id", async (req, res) => {
  try {
    ...
    const updatedDoador = await client.query(query, values);
...
app.delete("/doadores/:id", async (req, res) => {
  try {
    ...
    const deletedDoador = await client.query(query, [id]);
...
app.post("/interacoes", async (req, res) => {
  try {
    ...
    const newInteracao = await client.query(query, values);
...
app.get("/interacoes", async (req, res) => {
  try {
    ...
    const allInteracoes = await client.query(query);
...
app.put("/interacoes/:id", async (req, res) => {
  try {
    ...
    const updatedInteracao = await client.query(query, values);
...
app.delete("/interacoes/:id", async (req, res) => {
  try {
    ...
    const deletedInteracao = await client.query(query, [id]);
...
app.post("/usuarios", async (req, res) => {
  try {
    ...
    const newUsuario = await client.query(query, values);
...
app.get("/usuarios", async (req, res) => {
  try {
    ...
    const allUsuarios = await client.query(query);
...
app.put("/usuarios/:id", async (req, res) => {
  try {
    ...
    const updatedUsuario = await client.query(query, values);
...
app.delete("/usuarios/:id", async (req, res) => {
  try {
    ...
    const deletedUsuario = await client.query(query, [id]);
...
app.post("/doacoes", async (req, res) => {
  try {
    ...
    const newDoacao = await client.query(query, values);
...
app.get("/doacoes", async (req, res) => {
  try {
    ...
    const allDoacoes = await client.query(query);
...
app.put("/doacoes/:id", async (req, res) => {
  try {
    ...
    const updatedDoacao = await client.query(query, values);
...
app.delete("/doacoes/:id", async (req, res) => {
  try {
    ...
    const deletedDoacao = await client.query(query, [id]);
